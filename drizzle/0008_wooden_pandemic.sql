ALTER TYPE "public"."deployment_status" ADD VALUE IF NOT EXISTS 'superseded';--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "deployment" ADD COLUMN IF NOT EXISTS "superseded_by" text;--> statement-breakpoint
...
ALTER TABLE "deployment" DROP CONSTRAINT IF EXISTS "deployment_superseded_by_deployment_id_fk";--> statement-breakpoint
