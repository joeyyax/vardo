        ...
        <BlurFade>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-6">
                Billing that follows naturally
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                Time, scope, and expenses are already connected to the project
                they belong to. When it&apos;s time to invoice, everything is
                already there — no chasing, no reconciling, no surprises.
              </p>
              <p className="text-lg font-medium">
                Invoicing becomes a formality, not a project.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <StaggerContainer className="space-y-3">
                {[
                  {
                    label: "Time entries",
                    desc: "Linked to tasks and projects — hours flow into invoices at the correct rate.",
                  },
                  {
                    label: "Expenses",
                    desc: "Categorized and attached to projects — included automatically when billing.",
                  },
                  {
                    label: "Invoices",
                    desc: "Generated from tracked work — no manual assembly or reconciliation required.",
                  },
                ].map((item, i) => (
                  <StaggerItem key={i}>
                    <MagicCard className="p-4" gradientSize={120}>
                      <h3 className="font-semibold text-sm mb-1">
                        {item.label}
                      </h3>
