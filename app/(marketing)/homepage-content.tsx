        ...
        <BlurFade>
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4">
                Independently built and self-funded
              </h2>
            </div>
            ...
            <div className="grid sm:grid-cols-3 gap-6 mb-10">
              {[
                {
                  title: "Pricing stays predictable",
                  desc: "No per-seat charges, no feature gating, no surprise paywalls.",
                  gradient: "#40a8ff",
                },
                {
                  title: "The product stays focused",
                  desc: "Features serve the existing audience, not investor milestones.",
                  gradient: "#9c40ff",
                },
                {
                  title: "Incentives are aligned",
                  desc: "Scope succeeds when users succeed, not when usage metrics grow.",
                  gradient: "#ffaa40",
                },
              ].map((item, i) => (
                <motion.div
