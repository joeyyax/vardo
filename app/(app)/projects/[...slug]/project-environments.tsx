...
export function ProjectEnvironments({
  ...
  async function handleCreate() {
    ...
    try {
      const res = await fetch(
        `/api/v1/organizations/${orgId}/projects/${projectId}/environments`,
        {
          method: "POST",
  ...
  async function handleClone(sourceId: string) {
    ...
    try {
      const res = await fetch(
        `/api/v1/organizations/${orgId}/projects/${projectId}/environments/${sourceId}/clone`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
  ...
  async function handleUpdateDomain(envId: string) {
    try {
      const res = await fetch(
        `/api/v1/organizations/${orgId}/projects/${projectId}/environments/${envId}`,
        {
          method: "PATCH",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
  ...
  async function handleDelete() {
    ...
    try {
      const res = await fetch(
        `/api/v1/organizations/${orgId}/projects/${projectId}/environments/${deleteTarget.id}`,
        { method: "DELETE" }
      );
