...
description: Create your account, set up an organization, and deploy your first app on Vardo.
---
...
- Read [Concepts](/docs/concepts) to understand how projects, apps, environments, and deployments work together.
- See [Configuration](/docs/configuration) for environment variables, feature flags, and `vardo.yml` config as code.
- Check the [API Reference](/docs/api-reference) to automate deployments and integrate with CI/CD.
- See [Installation](/docs/installation) if you haven't set up your server yet.
