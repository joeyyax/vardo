---
title: Deployment
description: Deploy types, blue-green strategy, health checks, rollbacks, and GitHub integration.
---
...
See [Configuration](/docs/configuration) for the full `vardo.yml` reference.
