...
It connects time, tasks, projects, proposals, contracts, and billing into a single, predictable workflow — without becoming an admin-heavy tool or an all-in-one platform.
...
**Proposal → Agreement → Onboarding → Active work → Ongoing / Offboarding**

Scope makes this lifecycle explicit and supports it through structure, defaults, and visibility.
...
- Reports summarize reality
- They do not prescribe action
- Trends are visible
- Context is preserved
- Archived work is included intentionally
