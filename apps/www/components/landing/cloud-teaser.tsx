    ...
    <Section>
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:gap-8">
        ...
        <div className="rounded-xl border border-neutral-700 bg-neutral-900 p-8">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs font-medium text-white">
          ...
          <Link
            ...
            className="mt-6 inline-flex h-10 items-center rounded-lg bg-white px-5 text-sm font-medium text-neutral-950 transition-colors duration-150 hover:bg-neutral-200"
          >
            Get Started
          </Link>
        </div>
